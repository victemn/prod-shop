...
function sliceAndSplice(original, start, deleteCount) {
  ...
  returnArray.splice.apply(returnArray, __spreadArray2([start, deleteCount], args, false));
  return returnArray;
}
...
function auditTrail(query, options) {
  ...
  return collectionChanges(query, options).pipe(scan(function(current, action) {
    return __spreadArray2(__spreadArray2([], current, true), action, true);
  }, []));
}
